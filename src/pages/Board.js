      ...
      <tr key={topic.id}>
        <td>
          <a
            ...
            onClick={(event) => {
              event.preventDefault();
              props.onChangeMode(Number(topic.id));
            }}
          >
            {topic.title}
          </a>
...
function Board() {
  ...
  if(mode==="WELCOME"){
    content = <Article title="Welcome" body="새로운 글을 작성해주세요"></Article>
    contextControl = <>
  ...
  return (
    <>
      <Header title="여행의 조각" onChangeMode={() => {
        setMode('WELCOME');
      }}></Header>

      <div class="background">
        <div class="titlebar">게시글</div>
        <div class="content">
